...
namespace OCMovers_MC4.Areas.WeMoveIt.Controllers
{
    ...
    public class InventoryController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Edit(InventoryItem i)
        {
            InventoryItem inventoryitem = db.InventoryItem.Find(i.InventoryItemID);

            inventoryitem.inventoryItem = i.inventoryItem;
